...
class LiveWav2Vec2:
    ...
    def vad_process(device_name, asr_input_queue):
        ...
        FRAME_DURATION = 30
        CHUNK = int(RATE * FRAME_DURATION / 1000) #480
    ...
    def asr_process(model_name, in_queue, output_queue):
        ...
        while True:
            ...
            # print('buffer shape ',float64_buffer.shape)
    ...
    def get_input_device_id(device_name, microphones):
        # print('get input device id function ')
    ...
    def list_microphones(pyaudio_instance):
        # print('list microphones  function ')
...
if __name__ == "__main__":
    ...
    german_model = "oliverguhr/wav2vec2-large-xlsr-53-german-cv9" # the origen model
    asr = LiveWav2Vec2(english_model)
